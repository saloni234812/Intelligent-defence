...
import { Shield, Radar, Camera, AlertTriangle, Eye, Lock, Send, CheckCircle, Clock, Zap, LogOut } from 'lucide-react';
...
const Main = ({ setUser }) => {
  ...
  const handleLogout = async () => {
    try {
      ...
      if (res.ok) {
        setUser(null); // reset user in App.jsx
      } else {
      ...
      <header className="flex items-center justify-between mb-6">
        ...
        <div className="flex items-center gap-4">
          ...
          <button
            ...
            className="flex items-center gap-1 bg-red-600 hover:bg-red-700 px-3 py-1 rounded text-xs text-white font-mono"
          >
